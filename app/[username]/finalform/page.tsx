...
const finalform = ({ params }: { params: any }) => {
  ...
  if(session) return (
    ...
    return (
      <>
        <div className="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16 bg-emerald-100">
          <div className="xl:pt-24 w-full xl:w-1/2 relative pb-60 lg:pb-24 pt-24 lg:mb-40">
            <div className="relative">
              <div className="absolute">
                <div className="">
                  <h1 className="my-2 text-gray-800 font-bold text-2xl">
                    In order to Subscribe/Donate. You need to Sign UP!
                  </h1>
                  <p className="my-2 text-gray-800">Sorry about that! Please visit our Sign In to get where you need to go.</p>
                  <Link href = "/Signin">
                    <button className="sm:w-full lg:w-auto my-2 shadow-xl rounded md py-4 px-8 text-center bg-emerald-700 text-white hover:shadow-emerald-400 hover:bg-gradient-to-t">Sign Me In!</button>
                  </Link>
